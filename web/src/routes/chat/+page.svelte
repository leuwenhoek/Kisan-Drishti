...
>
	<input
		...
		class="flex-grow px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 {animate
			? 'animate-pulse-once border-blue-400 shadow-lg'
			: ''}"
